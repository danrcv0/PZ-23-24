...
label = tk.Label(window, text="Введите номер месяца:", bg="#EEEEEE", font=("Arial", 16), )
label.pack(pady=10)
entry = tk.Entry(window, width=15, font=("Arial", 12))
entry.pack()

button = tk.Button(window, text="Определить время года", command=show_season, bg="#000000", fg="white", font=("Arial", 12, "bold"))
button.pack(pady=10)
